    ...
    <section className="w-full bg-primary py-20 px-6">
      <div className="max-w-2xl mx-auto flex flex-col items-center text-center gap-6">
        ...
        <div className="flex gap-3 mt-2">
          <button className="bg-white text-primary font-medium px-8 py-3 rounded-pill hover:bg-primary-light transition-colors duration-200">Mulai Analisis Gratis</button>
        </div>
      </div>
    </section>
  );
